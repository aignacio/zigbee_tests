 ...
 * CONSTANTS
 */
#define   TIME_PARKWAY_POLL   1000    //Control the time of polling of the read devices
#define   DEBUG_ULTRA        
/*********************************************************************
 * TYPEDEFS
 */
...
#ifdef DEBUG_ULTRA
  static uint8 DevListUltra[20][5];
#endif
